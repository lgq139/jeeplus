      ...
      <el-col :span="6">
        <chart-card>
          ...
          <div slot="card-content">
            <div class="text-3xl">
              <count-to :start-val="0" :end-val="info.payCount.num" :duration="info.payCount.duration" class="card-panel-num"/>
            </div>
...
import CountCard from "@/views/modules/sys/dashboard/analysis/CountCard";
