...
public class AESUtil {
     ...
     * @return
     */
    public static String encoder16(String content,String password) {
     ...
     */
    public static String decoder16(String hexStr,String password) throws UnsupportedEncodingException {
        byte[] byte2 = parseHexStr2Byte(hexStr);
