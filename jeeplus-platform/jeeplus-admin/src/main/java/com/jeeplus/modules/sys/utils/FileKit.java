...
public class FileKit {
    ...
    public static String getShareBaseDir(){
        String dir =  JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL  + "共享文档/";
    ...
    public static String getShareBaseUrl(){
        return  JeePlusProperites.USERFILES_BASE_URL +  "/共享文档/";
    }
    ...
    public static String getMyDocDir(){
        ...
        String dir = JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL + id + "/我的文档/";
        com.jeeplus.common.utils.FileUtils.createDirectory(dir);
        return dir;
    }
    /**
    ...
    public static String getAttachmentDir(){
        String id = UserUtils.getUser().getId();
        String dir = JeePlusProperites.newInstance().getUserfilesBaseDir() + JeePlusProperites.USERFILES_BASE_URL + id + "/程序附件/";
        com.jeeplus.common.utils.FileUtils.createDirectory(dir);
        return dir;
    }
    ...
    public static String getAttachmentUrl(){
        ...
        String id = UserUtils.getUser().getId();
        return  JeePlusProperites.USERFILES_BASE_URL + id + "/程序附件/";
    }
